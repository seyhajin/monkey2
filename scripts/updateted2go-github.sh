...
$mx2cc makeapp -apptype=gui -build -config=release -product=scripts/ted2go-github.products/$host/ted2 ../src/ted2go-github/Ted2.monkey2
...
then
	...
	rm -r -f $ted2
	mkdir $ted2
	cp -R ./ted2go-github.products/$host/assets $ted2/assets
	cp ./ted2go-github.products/$host/ted2 $ted2/ted2
