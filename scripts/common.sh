...
then
	...
	mx2cc_new="../src/mx2cc/mx2cc.buildv1.1.04/macos_release/mx2cc"
	
	ted2="../bin/ted2_macos.app"
	ted2_new="../src/ted2/ted2.buildv1.1.04/macos_release/ted2.app"
	ted2go_new="../src/ted2go/ted2.buildv1.1.04/macos_release/ted2.app"
	
	launcher="../Monkey2 (Macos).app"
	launcher_new="../src/launcher/launcher.buildv1.1.04/macos_release/launcher.app"
fi
